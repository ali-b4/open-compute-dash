...
- **Approved next increment:** none beyond the implemented Stage 1 scope. Proposed next: Stage 2A offline provider registry and fictional-provider tests. Live smoke tests, spending, and the website remain outside that proposal.
